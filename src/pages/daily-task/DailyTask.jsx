    ...
    return (
        <>
            <div className="h-screen relative bg-[url('../../public/images/home-bg.webp')] bg-cover bg-center w-full p-[18px]">
                ...
                <div className="w-full mx-auto mt-[28px] text-white px-[15px] py-[10px] font-medium flex justify-center items-center w-fit gap-4 rounded-[16px] border border-[rgba(255,255,255,0.2)] bg-gradient-to-br from-[rgba(255,255,255,0.15)] to-[rgba(255,255,255,0.02)] backdrop-blur-sm">
                    <button
                ...
                <div className="h-[47%] overflow-auto mt-[20px]">
                    ...
                    {activeTab === "Invite" && (
                        <>
                            <h1 className="text-white">Invite</h1>
                        </>
                    )}
